...
router.post('/buryPointProject/projectSimpleListByWebmonitorIdsWithPagination', BuryPointProjectController.projectSimpleListByWebmonitorIdsWithPagination);
...
// 根据公司ID获取统计汇总数据（点位总数、点位字段总数、卡片总数、SDK发布总数）
router.post('/buryPointProject/getStatisticsByCompanyId', BuryPointProjectController.getStatisticsByCompanyId);
