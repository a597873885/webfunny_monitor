...
const accountInfo = {
    ...
    localServerDomain: domainConfig.host.be,   // 系统后端服务域名 
    localServerPort: domainConfig.port.be,     // 系统后端服务端口号
    ...
    saveDays: otherConfig.logSaveDays.event,                       // 日志保存周期
