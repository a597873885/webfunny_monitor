...
const Utils = {
  ...
  /**
   * 根据时间范围字符串计算开始时间和结束时间
   * @param {String} timeRange - 时间范围字符串，如："近5分钟"、"近1小时"、"近2天"等
   * @returns {Object} {startTime: String, endTime: String} 格式为 "YYYY-MM-DD HH:mm:ss"
   */
  getTimeRange(timeRange) {
    ...
    // 获取分钟数
    const minutes = timeRangeMap[timeRange] || 60 // 默认1小时
